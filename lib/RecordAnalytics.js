...
class RecordAnalytics {
  ...
  getRecords(stationID, months) {
    ...
    if ((stationID !== undefined && stationID !== null) || (months !== undefined && months !== null)) {
   ...
   */
  getByDataByPortType(portType, stationID, months) {
  ...
  getByDataByPayType(payMethod, stationID, months) {
    const validRecords = this.getRecords(stationID, months);
    const invalidRecords = this.getInvalidRecords(stationID, months);
  ...
  getByDataBySessionStart(sessionStart, stationID, months) {
    const validRecords = this.getRecords(stationID, months);
    const invalidRecords = this.getInvalidRecords(stationID, months);
  ...
  getFaults(stationID, months) {
    ...
    const currentWeek = this.getWeekNumberOf(new Date(this.getTime()));
    ...
    for (let record of records) {
        ...
        let weekIndex = this.getWeekNumberOf(record['Start Time']);
